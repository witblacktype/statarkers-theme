...
10. Add the gitignore file to the root of your project/site (remove sample fromm the front of the file name), in here there are some handy ignores for Statamic.
...
You can visit [Statamic Themes](http://www.statamicthemes.io/themes) for more theme information and a demo is also availble [here](http://statarkers.statamicthemes.io). There is also a video which takes you through how to install the theme [here](http://www.statamicthemes.io/articles/installing-the-statarkers-statamic-theme).
